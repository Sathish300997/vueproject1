(function webpackUniversalModuleDefinition(root, factory) {
  ...
  else root["ag-grid-vue"] = factory(root["Vue"], root["agGrid"]);
})(
  typeof self !== "undefined" ? self : this,
  function (
    __WEBPACK_EXTERNAL_MODULE__8bbf__,
    __WEBPACK_EXTERNAL_MODULE__8bd4__
  ) {
    return /******/ (function (modules) {
      ...
      /******/ {
        ...
        /***/ fae3: /***/ function (
          ...
          // EXPORTS
          __webpack_require__.d(__webpack_exports__, "AgGridVue", function () {
            return /* reexport */ AgGridVue_AgGridVue;
          });
...
***************************************************************************** */
          ...
          var VueComponentFactory_VueComponentFactory = /** @class */ (function () {
            ...
            VueComponentFactory.getComponentType = function (
              parent,
              component
            ) {
              if (typeof component === "string") {
                var componentInstance = this.searchForComponentInstance(
                  parent,
                  component
                );
                if (!componentInstance) {
                  console.error(
                    "Could not find component with name of " +
                      component +
                      ". Is it in Vue.components?"
                  );
                  return null;
                }
                return external_commonjs_vue_commonjs2_vue_root_Vue_default.a.extend(
            ...
            VueComponentFactory.createAndMountComponent = function (
              params,
              componentType,
              parent
            ) {
            ...
            VueComponentFactory.searchForComponentInstance = function (
              parent,
              component,
              maxDepth
            ) {
              ...
              while (
                ...
                componentInstance =
                  currentParent.$options.components[component];
          ...
          var VueFrameworkComponentWrapper_VueFrameworkComponentWrapper = /** @class */ (function (
            _super
          ) {
            ...
            VueFrameworkComponentWrapper.prototype.createWrapper = function (
              component
            ) {
              var that = this;
              var DynamicComponent = /** @class */ (function (_super) {
                ...
                DynamicComponent.prototype.callMethod = function (name, args) {
                  ...
                  return frameworkComponentInstance[name].apply(
                    componentInstance,
                    args
                  );
                };
                DynamicComponent.prototype.addMethod = function (
                  name,
                  callback
                ) {
                  wrapper[name] = callback;
                };
                DynamicComponent.prototype.overrideProcessing = function (
                  methodName
                ) {
                  return (
                    that.parent.autoParamsRefresh && methodName === "refresh"
                  );
                };
                DynamicComponent.prototype.processMethod = function (
                  methodName,
                  args
                ) {
            ...
            VueFrameworkComponentWrapper.prototype.createComponent = function (
              component,
              params
            ) {
              var componentType = VueComponentFactory_VueComponentFactory.getComponentType(
                this.parent,
                component
              );
              if (!componentType) {
              ...
              return VueComponentFactory_VueComponentFactory.createAndMountComponent(
                params,
                componentType,
                this.parent
              );
            };
            VueFrameworkComponentWrapper.prototype.createMethodProxy = function (
              wrapper,
              methodName,
              mandatory
            ) {
          ...
          var getAgGridProperties = function () {
            ...
            external_agGrid_["ComponentUtil"].ALL_PROPERTIES.forEach(function (
              propertyName
            ) {
              props[propertyName] = {};
          ...
          var AgGridColumn_AgGridColumn = /** @class */ (function () {
            ...
            AgGridColumn.createColDefFromGridColumn = function (column) {
              ...
              external_agGrid_["ColDefUtil"].BOOLEAN_PROPERTIES.forEach(
                function (property) {
          ...
          var AgGridVue_a = getAgGridProperties(),
            AgGridVue_props = AgGridVue_a[0],
            AgGridVue_watch = AgGridVue_a[1],
            AgGridVue_model = AgGridVue_a[2];
          var AgGridVue_AgGridVue = /** @class */ (function (_super) {
            ...
            AgGridVue.prototype.globalEventListener = function (
              eventType,
              event
            ) {
              if (this.isDestroyed) {
            ...
            AgGridVue.prototype.processChanges = function (
              propertyName,
              currentValue,
              previousValue
            ) {
              if (this.gridCreated) {
                if (
                  this.skipChange(propertyName, currentValue, previousValue)
                ) {
                  return;
                }
                var changes = {};
                ...
                external_agGrid_["ComponentUtil"].processOnChange(
                  changes,
                  this.gridOptions,
            ...
            AgGridVue.prototype.mounted = function () {
              ...
              this.emitRowModel = this.debounce(function () {
                _this.$emit(
                  "data-model-changed",
                  Object.freeze(_this.getRowData())
                );
              }, 20);
              var frameworkComponentWrapper = new VueFrameworkComponentWrapper_VueFrameworkComponentWrapper(
                this
              );
              var gridOptions = external_agGrid_[
                "ComponentUtil"
              ].copyAttributesToGridOptions(this.gridOptions, this);
              this.checkForBindingConflicts();
              gridOptions.rowData = this.getRowDataBasedOnBindings();
              if (AgGridColumn_AgGridColumn.hasChildColumns(this.$slots)) {
                gridOptions.columnDefs = AgGridColumn_AgGridColumn.mapChildColumnDefs(
                  this.$slots
                );
              }
              var gridParams = {
            ...
            AgGridVue.prototype.checkForBindingConflicts = function () {
              var thisAsAny = this;
              if (
                (thisAsAny.rowData || this.gridOptions.rowData) &&
                thisAsAny.rowDataModel
              ) {
                console.warn(
                  "ag-grid: Using both rowData and rowDataModel. rowData will be ignored."
                );
              }
            };
             ...
             */
            AgGridVue.prototype.skipChange = function (
              propertyName,
              currentValue,
              previousValue
            ) {
